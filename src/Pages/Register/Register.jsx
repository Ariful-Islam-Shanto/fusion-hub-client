  ...
  return (
    ...
    <div className="flex items-center w-full  justify-center py-12">
      <div className="relative px-10 mx-auto flex flex-col rounded-xl bg-transparent bg-clip-border md:3/4 lg:h-3/4 xl:w-2/4 text-gray-700 ">
        <h4 className="block font-sans mt-6 text-4xl font-bold leading-snug tracking-normal  text-center text-black antialiased">
        ...
        <form onSubmit={handleSubmit} className="mt-8 mb-2 w-full p-4">
          <div className="mb-4 flex flex-col gap-6 w-full">
            <div className="relative h-11 w-full min-w-[200px]">
              <input type="text" name="name"
                className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#ba1f53] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                placeholder=""
              />
          ...
          <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
            ...
            <Link to='/login'
              className="font-medium text-gray-500 transition-colors hover:text-blue-700"
              href="#"
            >
              Sign In
            </Link>
