      ...
      <div className="navbar ">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 bg-transparent backdrop-blur-2xl px-10 py-6 flex lg:gap-6 xl:gap-12"
            >
                ...
                <NavLink
                  className={({ isActive, isPending }) =>
                    isPending
                      ...
                      : isActive
                      ? "text-xs  text-[#a32650]"
                      : `text-xs  ${location.pathname === "/" ? "text-white" : "text-black"}`
                  }
                  to={"/"}
                >
                  HOME
          ...
          <a className="flex items-center gap-2 normal-case text-xl">
            ...
            <p className="font-bold">
              <span className="text-[#a32650] font-extrabold text-xl md:text-2xl lg:text-2xl xl:text-2xl">
                FUSION
              </span>
              HUB
            </p>
          ...
          {user ? (
            <>
              ...
              <Link
                ...
                className="bg-[#a32650] text-[8px]  text-white rounded-md py-2 px-4"
              >
                LOGOUT
              </Link>
            </>
            ...
            <Link
              to={"/login"}
              className="bg-[#a32650]   text-white rounded-md py-2 px-5 text-[8px]"
            >
              LOGIN
            </Link>
          )}
