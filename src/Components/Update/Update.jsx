...
const Update = () => {
    ...
    const handleUpdate = e => {
        ...
        fetch(`https://fusion-hub-server.vercel.app/update/${id}`, {
            method: "PUT",
            headers: {
...
console.log(data);
  return (
    <div className=" w-full h-[100vh] bg-cover bg-center backdrop-blur-3xl bg-blend-overlay">
      ...
      <div className="relative px-6 md:px-6 lg:px-12 xl:px-24 flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 h-full shadow-none">
        <form
          onSubmit={handleUpdate}
          className="mt-8 mb-2 w-full rounded-md mx-auto bg-white drop-shadow-md px-6  py-10 space-y-2"
        >
            <div className="mb-6">
          <h4 className="block text-center font-sans text-4xl font-semibold leading-snug tracking-normal text-gray-900  antialiased ">
            Update product
          </h4>
          <p className="mt-1 text-center block font-sans text-base font-normal leading-relaxed text-gray-900 antialiased">
            Update this product.
          </p >
          </div>
